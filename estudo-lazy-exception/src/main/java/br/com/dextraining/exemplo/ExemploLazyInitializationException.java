...
public class ExemploLazyInitializationException {

	public static void main(String args[]) {
		criarVendasNoBanco();

		List<Venda> vendas = consultarVendas();
	...
	private static List<Venda> consultarVendas() {
		EntityManager em = EntityManagerUtil.em();

		try {
			List<Venda> vendas = em.createQuery("FROM Venda v").getResultList();
			return vendas;
		} finally {
			em.close();
		}
